...
# --- 路径配置 ---
# 该文件位于 rl-serl/rl_robot_infra/robot_servers/openarm_server.py
# openarm / pyroki / IK 等底层硬件依赖仍住在 moqi_workspace 下（不迁移，import 复用）。
# parents: [0]=robot_servers [1]=rl_robot_infra [2]=rl-serl [3]=zy
ZY_ROOT = Path(__file__).resolve().parents[3]
