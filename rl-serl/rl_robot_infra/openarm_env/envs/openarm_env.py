...
# --- 路径设置 ---
# pyroki 提供 robot_ik_solver / realsense_camera 等底层依赖。
# 正常情况下 examples/compat.py 已把 moqi_workspace/pyroki 注入 sys.path；
# 这里再兜底一次，便于本模块被单独 import。
# 该文件位于 rl-serl/rl_robot_infra/openarm_env/envs/openarm_env.py
# parents: [0]=envs [1]=openarm_env [2]=rl_robot_infra [3]=rl-serl [4]=zy
